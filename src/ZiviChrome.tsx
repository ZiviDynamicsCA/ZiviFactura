...
export default function ZiviChrome() {
  ...
  return <header className="ziviChrome ziviChromeV28" aria-label="Cabecera de ZiviFactura">
    <button className="ziviChromeBrand ziviInstitutionalLockup" onClick={() => clickWorkspace(0)} aria-label="Ir al inicio">
      <img
        className="ziviApprovedHeaderLogo"
        src="/zivifactura-header-v28.png"
        alt="ZiviFactura por Zivi Dynamics C.A."
      />
    </button>
